...
export function initHomeExperience({ onWorkspaceChange } = {}) {
    ...
    const capabilityData = {
      ...
      flashcards: {
        ...
        placeholder: 'Enter a topic, or upload notes or slides to create flashcards',
      ...
      quiz: {
        ...
        placeholder: 'Enter a topic, or upload notes or slides to create a quiz',
      ...
      guide: {
        ...
        placeholder: 'Enter a topic, or upload notes or slides to create a study guide',
      ...
      mock: {
        ...
        placeholder: 'Enter your target exam, or upload study materials to build a personalized prep plan',
