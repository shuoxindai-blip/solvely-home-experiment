...
- 当前实现：题目图、视频缩略图、答案、公式和 hover 导览均封装在可直接 iframe 的本地 HTML 中，无外部运行时依赖
...
- 当前实现：示例详情和 3 张化学结构图均已本地化；切换逻辑封装在本地 HTML 中
...
- 代码入口：`capabilityData.solver.examples[3]` / `assets/solver-samples/financial-analysis.html`
...
| # | 分组 | 类型 | 用途 | URL |
|---:|---|---|---|---|
| E1 | `study.video.examples` | `remote_html` | Velocity & Distance Analysis 视频详情 | [HTML](https://img.justsolvely.com/solvely-solve/html/2025_07_14_fd4e936d9081a1ec45b9g_1768557153773.html) |
| E2 | `study.video.examples` | `remote_html` | Reading a BMI Dotplot 视频详情 | [HTML](https://img.justsolvely.com/solvely-solve/html/2026_01_10_dbd6a55ef31baa12ff35_1768795344086.html) |
| E3 | `study.video.examples` | `remote_html` | 3D Shapes & Nets 视频详情 | [HTML](https://img.justsolvely.com/solvely-solve/html/2026_01_11_bc9d48edb87b30c11777_1768810149374.html) |
