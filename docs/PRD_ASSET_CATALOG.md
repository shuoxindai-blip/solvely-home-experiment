...
### 4.3 `study.solver.intersecting-circles`

- 页面/模块：Study · Solver
- 场景：相交圆视频讲解
- 代码入口：`capabilityData.solver.examples[1]`
- 外部依赖：`externalResources[0]` 中的 Solvely 远程 video-player HTML

| # | 索引文件 | 用途 | 状态 |
|---:|---|---|---|
| 7 | `assets/solver-video-intersecting-circles.png` | 视频讲解示例卡片封面 | `runtime` |
...
| # | 索引文件 | 用途 | 状态 |
|---:|---|---|---|
| 8 | `assets/solver-chemistry-structure-cover.png` | 化学结构示例卡片封面 | `runtime` |
| 9 | `assets/chemistry-structure.png` | 原始紧凑版化学结构参考图 | `source` |
...
| # | 索引文件 | 用途 | 状态 |
|---:|---|---|---|
| 10 | `assets/solver-financial-analysis-cover.webp` | 财务分析示例卡片封面 | `runtime` |
...
| # | 索引文件 | 用途 | 状态 |
|---:|---|---|---|
| 11 | `assets/graph-reflection-over-y-axis.png` | 示例卡片封面 | `runtime` |
| 12 | `assets/simulators/reflection-over-y-axis.html` | 本地互动详情页 | `runtime` |
...
| # | 索引文件 | 用途 | 状态 |
|---:|---|---|---|
| 13 | `assets/graph-negative-externality.png` | 示例卡片封面 | `runtime` |
| 14 | `assets/simulators/negative-externality-pigouvian-tax.html` | 本地互动详情页 | `runtime` |
...
| # | 索引文件 | 用途 | 状态 |
|---:|---|---|---|
| 15 | `assets/graph-limits-at-infinity.png` | 示例卡片封面 | `runtime` |
| 16 | `assets/simulators/limits-at-infinity.html` | 本地互动详情页 | `runtime` |
...
| # | 索引文件 | 用途 | 状态 |
|---:|---|---|---|
| 17 | `assets/video-physics.png` | Velocity & Distance Analysis 预览图 | `runtime` |
| 18 | `assets/video-statistics.png` | Reading a BMI Dotplot 预览图 | `runtime` |
| 19 | `assets/video-geometry.png` | 3D Shapes & Nets 预览图 | `runtime` |
...
| # | 分组 | 类型 | 用途 | URL |
|---:|---|---|---|---|
| E1 | `study.solver.intersecting-circles` | `remote_html` | Intersecting Circles 视频讲解详情 | [HTML](https://img.justsolvely.com/solvely-solve/html/2026_08_24_f0259c07361fe821ce3e_1787583893888.html) |
| E2 | `study.solver.chemistry-structure` | `remote_image` | (m)-Ethylaniline 实际结构图 | [Image](https://img.justsolvely.com/chemistry-pubchem/2026_07_15_bfcc7f6ceeaa64fe224a_1784127249983.png) |
| E3 | `study.solver.chemistry-structure` | `remote_image` | SF₄ Lewis structure 实际结构图 | [Image](https://img.justsolvely.com/chemistry-pubchem/2026_07_14_5dafb19eb3243e0b8432_1784066879099.png) |
| E4 | `study.solver.chemistry-structure` | `remote_image` | 2-Isopropyloxolane 实际结构图 | [Image](https://img.justsolvely.com/chemistry-pubchem/2026_07_27_631128b862b4e2c5ac59_1785170849765.png) |
| E5 | `study.video.examples` | `remote_html` | Velocity & Distance Analysis 视频详情 | [HTML](https://img.justsolvely.com/solvely-solve/html/2025_07_14_fd4e936d9081a1ec45b9g_1768557153773.html) |
| E6 | `study.video.examples` | `remote_html` | Reading a BMI Dotplot 视频详情 | [HTML](https://img.justsolvely.com/solvely-solve/html/2026_01_10_dbd6a55ef31baa12ff35_1768795344086.html) |
| E7 | `study.video.examples` | `remote_html` | 3D Shapes & Nets 视频详情 | [HTML](https://img.justsolvely.com/solvely-solve/html/2026_01_11_bc9d48edb87b30c11777_1768810149374.html) |
